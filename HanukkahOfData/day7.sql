...
create temp view girls_id AS select 4167 AS customerid;
...
create temp view buyers_of_same_item_different_color_same_date AS select o.customerid
FROM orders o
...
select c.customerid, c.phone, c.name
