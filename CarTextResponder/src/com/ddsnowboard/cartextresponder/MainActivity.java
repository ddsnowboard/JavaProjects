...
// I need to figure out if it can store a certain bluetooth device and act when it is connected. It doesn't want to. 
		 ...
		 ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1, listOfPairs);
		    ...
		    listview.setOnItemClickListener(new OnItemClickListener() {      
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					Toast.makeText(getBaseContext(),"The change has been saved!" , Toast.LENGTH_SHORT).show();
